...
namespace LibModPlugSharp
{
	...
	public static class LibModPlugNative
	{
		...
		public static extern IntPtr ModPlug_Load(byte[] data, int size);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr ModPlug_GetPattern(IntPtr modFileHandle, int pattern, out uint numRows);
		#endregion
	}
}
