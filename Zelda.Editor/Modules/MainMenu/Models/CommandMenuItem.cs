...
namespace Zelda.Editor.Modules.MainMenu.Models
{
    public class CommandMenuItem : StandardMenuItem, ICommandUiItem
    {
        ...
        readonly StandardMenuItem _parent;
        readonly List<StandardMenuItem> _listItems;
        ...
        void ICommandUiItem.Update(CommandHandlerWrapper commandHandler)
        {
            ...
            _listItems.Do(item => _parent.Children.Remove(item));
            _listItems.Clear();
            ...
            {
                var newMenuItem = new CommandMenuItem(command, _parent) { IsListItem = true };
